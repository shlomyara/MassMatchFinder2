...
selected_list_name = st.selectbox("Select the dataset to use:", list(data_config.keys()))
...
st.markdown(f"**Using {selected_list_name} dataset** with {len(list2_raw)} List2 modifiers.")

# --- Split list2_raw into + and - groups ---
list2_add, list2_sub = [], []
